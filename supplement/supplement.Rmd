...
The questions were translated to parents' native language by a native speaker. The number of older children living in the same household was computed by subtracting one (the child completing the study) and the number of younger children from the total number of children. Whenever parents were not able to read or write (most relevant for Chimfunshi, BaYaka, Bandongo, Khwe, Ha||om), research assistants asked the question and recorded the answer. 
