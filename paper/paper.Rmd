...
A more detailed description of the materials and models can be found in the supplemental material. The experimental procedure and analysis plan were pre-registered (https://osf.io/tdsvc). We report on deviations from the pre-registered plan in the supplementary material. The task itself, including all the versions used in the study, can be accessed via the following website: https://ccp-odc.eva.mpg.de/tango-cc/. Data, model and analysis scripts can be found in an online repository (https://github.com/ccp-eva/gafo-cc-analysis).
...
The focal vector-based gaze estimation model has been described in detail in @prein2023variation. In brief, it inversely models the process generating touches on the screen based on observed eye movements. Formally, the model is defined as:
