...
## Developmental roots of gaze following
...
```{r}
## save fixed effects fro winning model
...
```{r}
## saved fixed effects for houshold composition models
# pred_est_sc <- 
#   bind_rows(
#   fixef(bm_pred_tc_hh)%>%
#   as_tibble(rownames = "term")%>%
