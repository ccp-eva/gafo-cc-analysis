...
bm_full_fix <- brm(mean_click ~ ageinyears + touchscreen + household + younger_children + children + (ageinyears |community), 
                              data   = scdata, 
                              family = lognormal(),
                              warmup = 2000, 
                              iter   = 4000, 
...
bm_fullc_fix <- brm(mean_click ~ ageinyears + touchscreen + younger_children + older_children + (ageinyears |community), 
                              data   = scdata, 
                              family = lognormal(),
                              warmup = 2000, 
                              iter   = 4000, 
...
bm_full_rand <- brm(mean_click ~ ageinyears + touchscreen + household + younger_children + older_children + (touchscreen + household + younger_children + older_children + ageinyears |community), 
                              data   = scdata, 
                              family = lognormal(),
                              warmup = 2000, 
                              iter   = 4000, 
...
bm_cts_fix_int <- brm(mean_click ~ ageinyears * children + touchscreen  + (ageinyears |community), 
                              data   = scdata, 
                              family = lognormal(),
                              warmup = 2000, 
                              iter   = 4000, 
...
bm_cts_rand_int <- brm(mean_click ~ ageinyears * children + touchscreen + (ageinyears * children + touchscreen |community), 
                              data   = scdata, 
                              family = lognormal(),
                              warmup = 2000, 
                              iter   = 4000, 
...
bm_ycts_fix <- brm(mean_click ~ ageinyears + touchscreen + younger_children + (ageinyears |community), 
                              data   = scdata, 
                              family = lognormal(),
                              warmup = 2000, 
                              iter   = 4000, 
...
bm_octs_fix <- brm(mean_click ~ ageinyears + touchscreen + older_children + (ageinyears |community), 
                              data   = scdata, 
                              family = lognormal(),
                              warmup = 2000, 
                              iter   = 4000, 
...
bm_octs_fix_int <- brm(mean_click ~  touchscreen + ageinyears * older_children + (ageinyears |community), 
                              data   = scdata, 
                              family = lognormal(),
                              warmup = 2000, 
                              iter   = 4000, 
...
bm_octs_rand <- brm(mean_click ~ ageinyears + touchscreen + older_children + (ageinyears + touchscreen + older_children |community), 
                              data   = scdata, 
                              family = lognormal(),
                              warmup = 2000, 
                              iter   = 4000, 
...
bm_octs_rand_int <- brm(mean_click ~ touchscreen + ageinyears*older_children + (ageinyears * older_children |community), 
                              data   = scdata, 
                              family = lognormal(),
                              warmup = 2000, 
                              iter   = 4000, 
...
model_weights(bm_base,
            ...
            #bm_hhts_rand_2, 
            #bm_hhts_rand,
            criterion = "loo")%>%as_tibble(rownames = "model")
...
bm_trial_pred <- brm(click ~ targetcentralityx + ageinyears + touchscreen + older_children + (targetcentralityx|subjid)+ (ageinyears + touchscreen + older_children |community),
                              data   = mdata, 
                              family = Gamma(link = "log"),
                              warmup = 2000, 
                              iter   = 6000, 
