...
```{r}
data <- merge_raw_data%>%
  select(subjid, community, age_group, ageinyears, sex, screen, touchscreen, household, children, younger_children, trialnr, targetposition,targetcenterx, targetcentralityx, clickdistfromtargetcenterx, inwardclick)%>%
  filter(ageinyears > 1)
