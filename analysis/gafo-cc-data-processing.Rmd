...
data <- bind_rows(
  ...
  select(subjid, community, age_group, ageinyears, sex, screen, touchscreen, household, children, younger_children, trialnr, targetposition, targetcentralityx, clickdistfromtargetcenterx)%>%
  filter(ageinyears > 1)
