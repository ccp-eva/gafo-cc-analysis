...
ggplot()+
  geom_line(data = guess_samp, aes(x = age+3, y = guess, group = paste(chain,iteration)), alpha = .01)+
  #geom_line(data = inf_samp, aes(x = age+3, y = uci), lty = 2)+
  #geom_line(data = inf_samp, aes(x = age+3, y = lci), lty = 2)+
  geom_line(data = guess_map, aes(x = age+3, y = guess), col = "firebrick")+
...
ggplot()+
  geom_line(data = bias_samp, aes(x = age+3, y = bias, group = paste(chain,iteration)), alpha = .01)+
  #geom_line(data = inf_samp, aes(x = age+3, y = uci), lty = 2)+
  #geom_line(data = inf_samp, aes(x = age+3, y = lci), lty = 2)+
  geom_line(data = bias_map, aes(x = age+3, y = bias), col = "firebrick")+
  xlim(3,6)+
  facet_grid(~community)+
  xlab("Age")+
  ylim(0,1)+
...
ggplot()+
  geom_line(data = inf_samp, aes(x = age+3, y = sd_inf, group = paste(chain,iteration)), alpha = .01, size = 0.1)+
   # geom_line(data = inf_samp, aes(x = age+3, y = uci), lty = 2)+
   # geom_line(data = inf_samp, aes(x = age+3, y = lci), lty = 2)+
  geom_line(data = inf_map, aes(x = age+3, y = sd_inf), col = "firebrick")+
  xlim(3,6)+
  facet_grid(~community)+
