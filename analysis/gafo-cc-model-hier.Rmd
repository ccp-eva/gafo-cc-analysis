...
model <- rbindlist(
  list(
     fread("../model/output/gafo-cc-hier_gran_20_chain1.csv"),
     fread("../model/output/gafo-cc-hier_gran_20_chain2.csv"),
     fread("../model/output/gafo-cc-hier_gran_20_chain3.csv"),
     fread("../model/output/gafo-cc-hier_gran_20_chain4.csv"),
     fread("../model/output/gafo-cc-hier_gran_20_chain5.csv")
    ), use.names=TRUE)#%>%saveRDS("../models/output/model_kids_box.rds")


#saveRDS(model, "../model/output/gafo-cc-model_hier.rds")
# 
...
ggplot(aes(x= value, fill = factor(chain)))+
  ...
  facet_grid(community~type, scales = "free_y")+
  theme_few()+
...
ggplot()+
  geom_line(data = guess_samp_com, aes(x = age+2.5, y = guess, group = paste(chain,iteration)), alpha = .01)+
  #geom_line(data = inf_samp, aes(x = age+3, y = uci), lty = 2)+
  #geom_line(data = inf_samp, aes(x = age+3, y = lci), lty = 2)+
  geom_line(data = guess_map_com, aes(x = age+2.5, y = guess), col = "firebrick")+
  facet_grid(~community)+
  #xlim(3,6)+
  xlab("Age")+
  ylim(0,1)+
...
ggplot()+
  geom_line(data = bias_samp_com, aes(x = age+2.5, y = bias, group = paste(chain,iteration)), alpha = .01)+
  #geom_line(data = inf_samp, aes(x = age+3, y = uci), lty = 2)+
  #geom_line(data = inf_samp, aes(x = age+3, y = lci), lty = 2)+
  geom_line(data = bias_map_com, aes(x = age+2.5, y = bias), col = "firebrick")+
  #xlim(3,6)+
  facet_grid(~community)+
  xlab("Age")+
  ylim(0,1)+
...
ggplot()+
  geom_line(data = inf_samp_com, aes(x = age+2.5, y = sd_inf, group = paste(chain,iteration)), alpha = .01, size = 0.1)+
   # geom_line(data = inf_samp, aes(x = age+3, y = uci), lty = 2)+
   # geom_line(data = inf_samp, aes(x = age+3, y = lci), lty = 2)+
  geom_line(data = inf_map_com, aes(x = age+2.5, y = sd_inf), col = "firebrick")+
  #xlim(3,6)+
  facet_grid(~community)+
  labs(x = "Age", y = "Gaze inference precision (across individuals)")+
  ylim(0,1)+
...
ggplot(alt, aes(x = age+2.5, y = value, fill = parameter))+
  geom_area(alpha = .75)+
  #xlim(3,6)+
  xlab("Age")+
  ylim(0,1)+
